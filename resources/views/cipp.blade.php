@extends('layouts.app-cipp')
@section('description')
    <meta name=""
          content="Увеличьте свой капитал с помощью платформы Проектный фонд и инвестиций в криптоактивы. Выберите новый токен и примите участие в pre-ICO.">
@endsection
@section('title')
    {{__('Проектный фонд - инвестиционная проектная платформа')}}
@endsection
@section('content')
    <main class="main">
        <section class="section-box">
            <div class="banner-hero hero-5">
                ...
                <div class="banner-inner-top">
                    <div class="container">
                        <div class="box-banner-left"><a class="btn btn-brand-5-new"
                                                        href="#"><span>1.0</span>{{__('блокчейн "ГАНИМЕД"')}}
                            ...
                            <div class="d-flex mb-60">
                                <a class="hover-up mr-5" href="#"><img
                                            src="{{asset('MainPublic/assets/imgs/page/homepage1/googleplay.png')}}"
                                            alt="PF"></a>
                                <a class="hover-up" href="#"><img
                                            src="{{asset('MainPublic/assets/imgs/page/homepage1/appstore.png')}}"
                                            alt="PF"></a></div>
                        </div>
                ...
                <div class="banner-inner-bottom">
                    <div class="container">
                        <div class="box-joined">
                            <div class="box-authors"><span class="item-author"><img
                                            src="{{asset('MainPublic/assets/imgs/page/homepage1/author.png')}}"
                                            alt="PF"></span><span class="item-author"><img
                                            src="{{asset('MainPublic/assets/imgs/page/homepage1/author2.png')}}"
                                            alt="Nivia"></span><span class="item-author"><img
                                            src="{{asset('MainPublic/assets/imgs/page/homepage1/author3.png')}}"
                                            alt="PF"></span><span class="item-author"><span
                                            class="text-num-author text-md-bold color-brand-2">+2k</span></span></div>
                            <span class="text-lg d-inline-block">{{__('Все больше пользователей используют нашу общую инвестиционную платформу!')}}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-box box-pricing-2 box-pricing-3">
            <div class="container"><a class="btn btn-brand-4-sm" href="#">{{__('Как это работает')}}</a>
                <h2 class="mt-15 mb-20">{{__('Всего 3 простых и быстрых шага')}}<br
                            class="d-none d-lg-block">{{__(' для размещения проекта или запуска инвестиций в работу!')}}
                </h2>
                <p class="text-lg neutral-500 mb-55">{{__('Цифровая инвестиционная проектная платформа создана для того, чтобы сделать процесс инвестирования простым и доступным для всех.')}}
                    <br class="d-none d-lg-block">{{__('Мы стремимся обеспечить прозрачность и безопасность, помогая вам достигать ваших финансовых целей!')}}
                </p>
                <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="box-border-rounded">
                            <div class="card-casestudy">
                                ...
                                <div class="card-desc">
                                    <p>
                                        <strong>{{__('- Для инициаторов проектов: ')}}</strong>{{__('Разместите и активируйте свой проект, создайте проектное «пространство» и выберите подходящую финансовую модель. Ознакомьтесь с инвестиционными предложениями.')}}
                                    </p>
                                    <p>
                                        <strong>{{__('- Для инвесторов: ')}}</strong>{{__('Исследуйте доступные проекты, выберите интересные и запустите свой инвестиционный портфель.')}}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-border-rounded">
                            <div class="card-casestudy">
                                ...
                                <div class="card-desc">
                                    <p>
                                        <strong>{{__('- Для инициаторов проектов: ')}}</strong>{{__('Ваш проект проинвестирован и реализовано задуманное.')}}
                                    </p>
                                    <p>
                                        <strong>{{__('- Для инвесторов: ')}}</strong>{{__('Ваш портфель будет приносить стабильный доход. Система автоматического контроля распределения (проектные smart контракты) и прозрачная отчетность обеспечат защиту от нецелевого использования инвестиций.')}}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-pricing card-pricing-style-2 card-pricing-style-3">
                                ...
                                <div class="card-button"><a class="btn btn-get-started"
                                                            href="#">{{__('У меня есть проект')}}
                                        <svg width="23" height="8" viewbox="0 0 23 8" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M22.5 3.99934L18.9791 0.478516V3.30642H0.5V4.69236H18.9791V7.52031L22.5 3.99934Z"
                                                  fill=""></path>
                                        </svg>
                                    </a></div>
                                <div class="card-lists"><strong
                                            class="text-18-bold">{{__('Полный набор инвестиционного проектного сопровождения')}}</strong>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                                ...
                                                <g clip-path="url(#clip0_51_57)">
                                                    <path d="M13 26C20.1799 26 26 20.1799 26 13C26 5.8201 20.1799 0 13 0C5.8201 0 0 5.8201 0 13C0 20.1799 5.8201 26 13 26Z"
                                                          fill="#C5FF55"></path>
                                                    <path d="M7.11719 13.8396L10.479 17.2014L18.8835 8.79688"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-pricing card-pricing-style-2 card-pricing-style-3">
                                ...
                                <div class="card-lists"><strong
                                            class="text-18-bold">{{__('Обеспечение инвестиций, прозрачность и безопасность')}}</strong>
                                    <ul class="list-feature">
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                                 viewbox="0 0 26 26" fill="none">
            ...
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-8 mb-30">
                        <div class="row align-items-end">
                            <div class="col-sm-3 col-6 mb-30"><img
                                        src="{{asset('MainPublic/assets/imgs/page/about/award.png')}}" alt="PF"></div>
                            <div class="col-sm-3 col-6 mb-30"><img
                                        src="{{asset('MainPublic/assets/imgs/page/about/award2.png')}}" alt="PF"></div>
                            <div class="col-sm-3 col-6 mb-30"><img
                                        src="{{asset('MainPublic/assets/imgs/page/about/award3.png')}}" alt="PF"></div>
                            <div class="col-sm-3 col-6 mb-30"><img
                                        src="{{asset('MainPublic/assets/imgs/page/about/award4.png')}}" alt="PF"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-our-track">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 text-center mb-40"><img
                                src="{{asset('MainPublic/assets/imgs/page/homepage1/img-track.png')}}" alt="PF"></div>
                    <div class="col-lg-6 mb-40">
                        <div class="box-padding-left-50">
                            ...
                            <p class="text-lg neutral-700">Nivia is an independent web design studio with a rich
                                history. Founded in 1999, it gathered the best web designers &amp; developers.</p>
                            <div class="row mt-50">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        <div class="card-image"><img src="assets/imgs/page/homepage3/marketing.svg">
                                        </div>
                                        <div class="card-info"><a href="#">
                                                <h3 class="text-22-bold">Intuitive Dashboard</h3></a>
                                            <p class="text-md neutral-700">Unlocking Audience Insights: A Deep Dive into
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        ...
                                        <div class="card-info"><a href="#">
                                            ...
                                            <p class="text-md neutral-700">Measuring Digital Success: The Power of
                                                Engagement Analysis</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        ...
                                        <div class="card-info"><a href="#">
                                            ...
                                            <p class="text-md neutral-700">Boosting Conversions: Strategies Informed by
                                                Engagement Analysis</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        ...
                                        <div class="card-info"><a href="#">
                                            ...
                                            <p class="text-md neutral-700">Data-Driven Decisions: Leveraging Engagement
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-preparing-2">
            <div class="container">
                <div class="text-center">
                    <h2 class="mb-15">Preparing For Your Success,<br class="d-none d-lg-block">We Provide Truly
                        Prominent IT Solutions</h2>
                    <p class="text-lg neutral-700">Nivia is an independent web design studio with a rich history.<br>Founded
                        in 1999, it gathered the best web designers & developers.</p>
                </div>
                <div class="row mt-90">
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing">
                            <div class="card-image"><img class="wow fadeInUp"
                                                         src="assets/imgs/page/homepage1/img-prepare.png" alt="Nivia">
                            </div>
                            <div class="card-info">
                                <h5>Easy Control Panel</h5>
                                <p class="text-lg neutral-700 w-85 mx-auto">Mastering Your Domain with Effortless
                                    Control: Elevate Your Management Experience to New Heights of Ease and
                                    Efficiency.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing">
                            <div class="card-image"><img class="wow fadeInUp"
                                                         src="assets/imgs/page/homepage1/img-prepare2.png" alt="Nivia">
                            </div>
                            <div class="card-info">
                                <h5>Details Reporting</h5>
                                <p class="text-lg neutral-700 w-85 mx-auto">Achieve Business Excellence with
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing">
                            <div class="card-image"><img class="wow fadeInUp"
                                                         src="assets/imgs/page/homepage1/img-prepare3.png" alt="Nivia">
                            </div>
                            <div class="card-info">
                                <h5>Sales Comparison</h5>
                                <p class="text-lg neutral-700 w-85 mx-auto">Maximizing Your Data Potential: A Deep Dive
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-40">
                        <div class="strate-icon"><span></span> Strategies that work</div>
                        <h2 class="heading-2 mb-20">Track the progress towards objectives with key results</h2>
                        <p class="text-lg neutral-700">Nivia is an independent web design studio with a rich history.
                        ...
                        <div class="row mt-50">
                            <div class="col-lg-12">
                                <div class="card-feature-2">
                                    ...
                                    <div class="card-info"><a href="#">
                                            <h3 class="text-22-bold">Discover your best and worst performing
                                                audiences</h3></a>
                                        <p class="text-md neutral-700">Lorem ipsum dolor sit amet consectetur
                        ...
                        <div class="box-buttons-feature-4"><a class="btn btn-brand-4-medium mr-20" href="#">Subscribe
                                <svg width="22" height="8" viewbox="0 0 22 8" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M22 3.99934L18.4791 0.478516V3.30642H0V4.69236H18.4791V7.52031L22 3.99934Z"
                                          fill=""></path>
                                </svg>
                            </a><a class="btn btn-learmore-2" href="#"><span>
                    <svg width="39" height="38" viewbox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="0.5" width="38" height="38" rx="19" fill="#191919"></rect>
                      <g clip-path="url(#clip0_1_376)">
                        <path d="M24.1537 16.8139L15.218 25.7497L13.75 24.2817L22.6847 15.3459H14.81V13.2695H26.2301V24.6897H24.1537V16.8139Z"
                              fill="#C5FF55"></path>
                      </g>
                      <defs>
                    ...
                    <div class="col-lg-6 text-center mb-40">
                        <div class="box-border-image">
                            <div class="box-image-line-1">
                                <div class="wow fadeInDown img-1" data-wow-delay="0"><img
                                            src="assets/imgs/page/homepage1/img-track2-1.png" alt="Nivia"></div>
                                <div class="wow fadeInDown img-1" data-wow-delay="0.3s"><img
                                            src="assets/imgs/page/homepage1/img-track2-2.png" alt="Nivia"></div>
                            </div>
                            <div class="box-image-line-2">
                                <div class="wow fadeInLeft img-1" data-wow-delay="0"><img
                                            src="assets/imgs/page/homepage1/img-track2-3.png" alt="Nivia"></div>
                                <div class="wow fadeInRight img-1" data-wow-delay="0.2s"><img
                                            src="assets/imgs/page/homepage1/img-track2-4.png" alt="Nivia"></div>
                            </div>
                            <div class="box-image-line-3">
                                <div class="wow fadeInUp img-1" data-wow-delay="0"><img
                                            src="assets/imgs/page/homepage1/img-track2-5.png" alt="Nivia"></div>
                                <div class="wow fadeInUp img-2" data-wow-delay="0.2s"><img
                                            src="assets/imgs/page/homepage1/img-track2-6.png" alt="Nivia"></div>
                                <div class="wow fadeInUp img-3" data-wow-delay="0.4s"><img
                                            src="assets/imgs/page/homepage1/img-track2-7.png" alt="Nivia"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-preparing-3">
            <div class="container">
                <div class="text-center">
                    <h2 class="neutral-0 mb-20">Preparing For Your Success,<br class="d-none d-lg-block">We Provide
                        Truly Prominent IT Solutions</h2>
                    <p class="text-lg neutral-700">Nivia is an independent web design studio with a rich history.
                        Founded in 1999, it<br class="d-none d-lg-block">gathered the best web designers & developers.
                    </p>
                </div>
                <div class="row mt-90">
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#">
                            ...
                            <div class="card-info"><a href="#">
                                ...
                                <p class="text-md neutral-700">Strategic approach that involves creating and
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#">
                            ...
                            <div class="card-info"><a href="#">
                                ...
                                <p class="text-md neutral-700">Refers to the process of reevaluating and improving the
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#">
                            ...
                            <div class="card-info"><a href="#">
                                ...
                                <p class="text-md neutral-700"> Involves overseeing an organization's technology
                                    resources, including hardware, software, networks, and personnel, to ensure the
                                    efficient and secure operation of IT systems in alignment with business
                                    objectives.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#">
                            ...
                            <div class="card-info"><a href="#">
                                ...
                                <p class="text-md neutral-700"> An infrastructure plan outlines a comprehensive strategy
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#">
                            ...
                            <div class="card-info"><a href="#">
                                ...
                                <p class="text-md neutral-700">Signifies the enhancement of security measures, typically
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#">
                            ...
                            <div class="card-info"><a href="#">
                                ...
                                <p class="text-md neutral-700">The practice of safeguarding sensitive information from
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-30">
                        <div class="box-image-neutral-1000"><img src="assets/imgs/page/homepage1/img-discover.png"
                                                                 alt="Nivia"></div>
                    </div>
                    <div class="col-lg-6 mb-30">
                        <h2>Discover insights across all your data with Nivia Platform</h2>
                        <p class="text-lg neutral-500">Bole nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="item-review-discover">
                                                <p class="text-lg">I've been working with this digital marketing agency
                                                ...
                                                <div class="box-author-review">
                                                    <div class="box-author"><a href="#"><img
                                                                    src="assets/imgs/page/homepage1/author.png"
                                                                    alt="Nivia"></a>
                                                        <div class="author-info"><a href="#"><span class="author-name">Guy Hawkins</span></a><span
                                                                    class="text-sm color-600 department">Apple JSC</span>
                                                        </div>
                                                    </div>
                                                    <div class="author-brand"><a href="#"><img
                                        ...
                                        <div class="swiper-slide">
                                            <div class="item-review-discover">
                                                <p class="text-lg">Their communication is exceptional; they keep me
                                                ...
                                                <div class="box-author-review">
                                                    <div class="box-author"><a href="#"><img
                                                                    ...
                                                                    alt="Nivia"></a>
                                                        <div class="author-info"><a href="#"><span class="author-name">Rosie Jane</span></a><span
                                                                    class="text-sm color-600 department">Apple JSC</span>
                                                        </div>
                                                    </div>
                                                    <div class="author-brand"><a href="#"><img
        ...
        <section class="section-box box-why-trusted box-why-trusted-black">
            <div class="container">
                <div class="row align-items-end">
                    <div class="col-lg-4 mb-30">
                        <h2 class="text-32-bold">See why we are<br class="d-none d-lg-block"> trusted the world over
                        </h2>
                    </div>
                    <div class="col-lg-8 mb-30">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="box-faq-left"><a class="btn btn-brand-4-sm" href="#">Frequently Asked Questions</a>
                            ...
                            <p class="text-lg neutral-700">Below you’ll find answers to the most common questions you
                                ...
                                you’re looking for, just <a class="text-18-bold brand-1-1" href="#">Contact us</a></p>
                        </div>
                    </div>
                    <div class="col-lg-7">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="flush-collapseOne">What audiences can I target when creating
                                        my Facebook campaigns?
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="flush-collapseTwo">Can you provide benchmarks for Facebook
                                        advertising costs?
                                    </button>
                                </h2>
                                <div class="accordion-collapse collapse" id="flush-collapseTwo"
                                     aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFAQS">
                                    <div class="accordion-body">Discover what sets this apart as the market's easiest
                                        ...
                                        hiring managers consistently choose us over the competition
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="flush-collapseThree">Where will my Google Ads be shown?
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="flush-collapseFour">Which keywords should I use for my Google
                                        Ads campaigns?
                                    </button>
                                </h2>
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-testimonials-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-30"><img src="assets/imgs/page/homepage1/img-testimonial.png" alt="Nivia">
                    </div>
                    <div class="col-lg-6 mb-30">
                        <div class="row align-items-end">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card-testimonial-3">
                                            <div class="card-image"><img src="assets/imgs/page/homepage1/img-review.png"
                                                                         alt="Nivia"></div>
                                            <div class="card-info">
                                                <p class="text-md neutral-500">“As a long-time user of Nivia Platform's
                                                ...
                                                <div class="card-author-review">
                                                    <div class="card-author-info"><span
                                                                class="author-name">ROBERT FOX</span><span
                                                                class="author-tag">@Amazon</span></div>
                                                    <div class="card-rate"><img
                                                                ...
                                                                src="assets/imgs/page/homepage1/star.svg"
                                                                alt="Nivia"><img
                                                                src="assets/imgs/page/homepage1/star.svg" alt="Nivia">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card-testimonial-3">
                                            <div class="card-image"><img
                                                        src="assets/imgs/page/homepage1/img-review-2.png" alt="Nivia">
                                            </div>
                                            <div class="card-info">
                                                <p class="text-md neutral-500">“I recently started using Nivia Platform,
                                                ...
                                                <div class="card-author-review">
                                                    <div class="card-author-info"><span
                                                                class="author-name">ALAN WALKER</span><span
                                                                class="author-tag">@Facetime</span></div>
                                                    <div class="card-rate"><img
                                                                src="assets/imgs/page/homepage1/star.svg"
                                                                alt="Nivia"><img
                                                                src="assets/imgs/page/homepage1/star.svg"
                ...
                <div class="box-swiper mt-30">
                    <div class="swiper-container swiper-group-3">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card-news">
                                    <div class="card-image"><a href="blog-post.html"><img
                                                    src="assets/imgs/page/homepage1/img-news.png" alt="Nivia"></a></div>
                                    <div class="card-info"><a class="heading-4" href="blog-post.html">Now the pain is
                                            very important, and the teaching is consistent.</a>
                                        <p class="text-md neutral-700 mt-15 mb-35">Pellentesque at posuere tellus. Ut
                                            sed dui justo. Phasellus is scelerisque turpis arcu, ut pulvinar lectus
                                            tristique non. Nam laoreet, risus vel laoreet laoreet, mauris</p><a
                                                class="btn btn-learmore-2" href="blog-post.html"><span>
                          <svg width="13" height="13" viewbox="0 0 13 13" fill="none"
                               xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_24_999)">
                              <path d="M10.6557 3.81393L1.71996 12.7497L0.251953 11.2817L9.18664 2.34592H1.31195V0.269531H12.7321V11.6897H10.6557V3.81393Z"
                                    fill="#191919"></path>
                            </g>
                            <defs>
                            ...
                            <div class="swiper-slide">
                                <div class="card-news">
                                    <div class="card-image"><a href="blog-post.html"><img
                                                    src="assets/imgs/page/homepage1/img-news2.png" alt="Nivia"></a>
                                    </div>
                                    <div class="card-info"><a class="heading-4" href="blog-post.html">The behavior of
                                            the pain itself is important, consistent with</a>
                                        <p class="text-md neutral-700 mt-15 mb-35">Pellentesque at posuere tellus. Ut
                                            sed dui justo. Phasellus is scelerisque turpis arcu, ut pulvinar lectus
                                            tristique non. Nam laoreet, risus vel laoreet laoreet, mauris</p><a
                                                class="btn btn-learmore-2" href="blog-post.html"><span>
                          <svg width="13" height="13" viewbox="0 0 13 13" fill="none"
                            ...
                            <div class="swiper-slide">
                                <div class="card-news">
                                    <div class="card-image"><a href="blog-post.html"><img
                                                    src="assets/imgs/page/homepage1/img-news3.png" alt="Nivia"></a>
                                    </div>
                                    <div class="card-info"><a class="heading-4" href="blog-post.html">How startups can
                                            improve their chances of getting financing</a>
                                        <p class="text-md neutral-700 mt-15 mb-35">Pellentesque at posuere tellus. Ut
                                            sed dui justo. Phasellus is scelerisque turpis arcu, ut pulvinar lectus
                                            tristique non. Nam laoreet, risus vel laoreet laoreet, mauris</p><a
                                                class="btn btn-learmore-2" href="blog-post.html"><span>
