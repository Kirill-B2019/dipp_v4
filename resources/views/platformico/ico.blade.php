        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 mb-30">
                    ...
                    <h3 class="mb-25 mt-15 neutral-0">{{__('Новое единое цифровое решение для запуска проетов и инвестиций')}}</h3>
    ...
    <div class="list-change-log">
        ...
        <div class="item-log">
            ...
            <div class="info-log">
                ...
                <p class="text-md">{{__('Все модули протестированы и активны, справочники заполнены, идети активное продвижение платформы в качестве гаранта привлечения инвестиций и исполнения проектов. Подключен банк оператор - работают мультивалютные фиатные шлюзы.')}}</p>
                <ul class="list-check-black">
