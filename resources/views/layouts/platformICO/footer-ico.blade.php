<footer class="footer footer-style-3 footer-style-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 mb-30"><a href="index.html"><img alt="Nivia" src="assets/imgs/template/logo.svg"></a>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-6 text-lg-end text-center">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 mb-20">
                            <p class="text-sm neutral-600">Copyright &copy; <?= date('Y'); ?> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
