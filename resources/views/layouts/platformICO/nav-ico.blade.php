    ...
    <div class="container">
        <div class="main-header">
                ...
                <div class="header-nav">
                    <nav class="nav-main-menu d-none d-xl-block">
                        <ul class="main-menu">
                            ...
                            <li class="mega-li has-children"><a href="{{route('platform_ico')}}#about">{{__('О платформе')}}</a></li>
            ...
            <div class="header-right">
                <a class="btn btn-brand-4-medium hover-up" href="{{route('platform_ico')}}#buyPFTG">{{__('Купить PFTG')}}
