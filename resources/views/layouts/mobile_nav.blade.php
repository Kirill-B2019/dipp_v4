<div class="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-top">
            <div class="user-account"><img src="{{asset('MainPublic/assets/imgs/page/homepage6/author.png')}}" alt="ProjectsFund">
                <div class="content">
                    <h6 class="user-name">{{__('Кто-то')}}</h6>
        ...
        <div class="mobile-header-content-area">
            <div class="perfect-scroll">
                ...
                <div class="mobile-social-icon mb-50">
                    <h6 class="mb-25">Follow Us</h6><a class="icon-socials icon-facebook" href="#"><img alt="ProjectFund" src="{{asset('MainPublic/assets/imgs/template/icons/fb.svg')}}"></a><a class="icon-socials icon-instagram" href="#"><img alt="Nivia" src="assets/imgs/template/icons/in.svg"></a><a class="icon-socials icon-twitter" href="#"><img alt="Nivia" src="assets/imgs/template/icons/tw.svg"></a><a class="icon-socials icon-be" href="#"><img alt="Nivia" src="assets/imgs/template/icons/be.svg"></a>
                </div>
                <div class="site-copyright">Copyright 2025 &copy; Nivia.<br>Designed by KB.</div>
            </div>
        </div>
    </div>
</div>
